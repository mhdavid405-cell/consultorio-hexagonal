<?php
// templates/citas/actualizar.php
session_start();
...
Swal.fire({
    ...
    title: <?php echo $ok ? "'Actualizada correctamente'" : "'Error'"; ?>,
    text: <?php echo $ok ? "'La cita se actualizó correctamente.'" : "'No se pudo actualizar la cita.'"; ?>,
